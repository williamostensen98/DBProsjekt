...
public static void main(String[] args){
        ...
        Connection conn = dbconn.connect(); // dette du tenker på odd?
        ...
        String treningsformal = scanner.next();
        treningsformal += scanner.nextLine();
        System.out.println("Opplevelse: ");
        String opplevelse = scanner.next();
        opplevelse += scanner.nextLine();

        reg.registrer_treningsokt(conn,tidsstempel, varighet, form, prestasjon,treningsformal,opplevelse);
